---
title: "Read and write SPRUCE data on Amazon S3"
description: "Configure Spark and the AWS credentials needed to read usage reports from Amazon S3 and write the enriched output back to it."
---

# Read and write SPRUCE data on Amazon S3
