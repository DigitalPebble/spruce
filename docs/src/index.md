...
SPRUCE handles CUR reports from AWS and partially supports Azure. Both providers are also supported in [FOCUS 1.0](https://focus.finops.org/) format, alongside their native formats (CUR for AWS, legacy EA/MCA cost details for Azure). However, most of the cost from a typical usage already gets estimates.
