...
class UsageDateTest {
    ...
    @Test
    void readsTheYearFromTheFirstDateColumnThatIsFilled() {
        assertEquals(2025, UsageDate.year(row("2025-03-01T00:00:00Z", "2024-01-01T00:00:00Z", "2023-01")));
        assertEquals(2024, UsageDate.year(row(null, "2024-01-01T00:00:00Z", "2023-01")));
    ...
    @Test
    void readsTheAzureDateColumn() {
        StructType azure = new StructType(new StructField[]{
                StructField.apply(AzureColumn.DATE.getLabel(), DataTypes.DateType, true, null)});
        Row row = new GenericRowWithSchema(new Object[]{java.sql.Date.valueOf("2024-06-01")}, azure);
        assertEquals(2024, UsageDate.year(row));
    }
