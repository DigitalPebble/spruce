...
public class AzureColumnTest {
    ...
    public void testGetStringAndIsNullAt() {
        ...
        AzureColumn col = new AzureColumn(name, DataTypes.StringType);
        ...
        AzureColumn col2 = new AzureColumn("unknown", DataTypes.StringType);
    ...
    public void testGetDoubleAndIsNullAt() {
        ...
        AzureColumn col = new AzureColumn(name, DataTypes.DoubleType);
        assertFalse(col.isNullAt(r1));
