...
/** Get final energy usage and embodied emissions estimates from the BoaviztAPI **/
public class BoaviztAPIClient {

    private static final String URLPattern = "%s/v1/cloud/instance?provider=aws&instance_type=%s&verbose=false&duration=1&criteria=pe&criteria=gwp";
    ...
    public double[] getEnergyAndEmbodiedEmissionsEstimates(@NonNull Provider p, @NonNull String instanceType) throws IOException {
        ...
        try (Response response = client.newCall(request).execute()) {
            ...
            Map<String, Object> pe  = (Map<String, Object>) result.get("pe");
            Map<String, Object> use = (Map<String, Object>) pe.get("use");
            Double use_value_mj = (Double) use.get("value");
            final double final_energy_kwh = use_value_mj * MJtoKWh / PE_FACTOR_DEFAULT_LOCATION;

            Map<String, Object> gwp  = (Map<String, Object>) result.get("gwp");
