...
public class SpruceColumn extends Column {
    ...
    public static SpruceColumn WATER_COOLING = new SpruceColumn("water_cooling_liters", DoubleType);
    public static SpruceColumn WATER_ENERGY = new SpruceColumn("water_energy_liters", DoubleType);
